...
import { Send, Music, Loader2, Play, Plus, X, Trash2, GripVertical, RefreshCw, Search, Sparkles, Disc, CheckCircle2, ExternalLink, Globe } from "lucide-react";
        ...
        try {
            ...
            if (error.name !== 'AbortError') {
                ...
                setMessages((prev) => [
                    ...
                    {
                        role: "assistant",
                        content: t('chat.errors.aiFailed'),
                    },
                ]);
            }
        } finally {
            ...
            <header className="p-4 border-b border-neutral-800 flex items-center justify-between bg-neutral-900/50 backdrop-blur-md sticky top-0 z-10">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-neutral-800 hover:bg-neutral-700 transition-colors text-xs font-medium text-gray-300"
                    >
